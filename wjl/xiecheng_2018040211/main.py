...
driver.find_element_by_id("#txtCity").click()
driver.find_element_by_id("#txtCity").clear()
driver.find_element_by_id("#txtCity").send_keys(u"千岛湖")#搜索目的地
driver.find_element_by_id("#txtCity").send_keys(Keys.ENTER)#搜索目的地
